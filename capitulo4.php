...
<title>NetworkConcepts</title>
  ...
  <ul class="pager" >
    ...
    <li class="next"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo5.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
