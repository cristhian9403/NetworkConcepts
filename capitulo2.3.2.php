...
<title>NetworkConcepts</title>
  ...
  <ul class="pager" >
    ...
    <li class="next"><a  href="capitulo2.3.3.php" class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
