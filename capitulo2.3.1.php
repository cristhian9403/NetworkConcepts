...
<title>NetworkConcepts</title>
		...
		<div class="row">
                 		<section class="posts col-md-12" STYLE=" top:20px; left:1px;">
                 				<ol class="breadcrumb">
             				       ...
             				       <li class="active"><small>Capitulo 2.3.1</small></li>	
                 		</section>
             </div>
		<br>
		<br>
					...
					<div class="col-sm-6" STYLE="left:-65px; width:550px;" >
						...
						<div id="Layer1" style="width:550px; height:350px; overflow:scroll;">
							...
							<div class="panel-body" style="text-align: justify;" >
							 <h3 align="center"> <font color="#000080" ><b> 2.3.1 Dispositivos Finales </b></h3></font>
							 <br>
							...
							<br>
							<ul type="disk">
								<li> Computadoras (estaciones de trabajo, computadoras portátiles, servidores de archivos, servidores Web).</li>
								<li> Impresoras de red.</li>
								<li> Teléfonos VoIP.</li>
								<li> Cámaras de seguridad.</li>
								<li> Dispositivos móviles de mano (como escáneres de barras inalámbricos, asistentes digitales personales (PDA)).</li>
							</ul>
							
							<br>
                                En el contexto de una red, los dispositivos finales se denominan host. Un dispositivo host puede ser el origen o 
								el destino de un mensaje transmitido a través de la red. Para distinguir un host de otro, cada host en la red se 
								identifica por una dirección. Cuando un host inicia una comunicación, utiliza la dirección del host de destino 
								para especificar dónde debe ser enviado el mensaje.
							<br>
							<br>
							    En las redes modernas, un host puede funcionar como un cliente, como un servidor o como ambos. El software instalado 
								en el host determina qué rol representa en la red.
							<br>
							<br>
								Los servidores son hosts que tienen software instalado que les permite proporcionar información y servicios, como
								e-mail o páginas Web, a otros hosts en la red.
							<br>
							<br>
								Los clientes son hosts que tienen software instalado que les permite solicitar y mostrar la información obtenida 
								del servidor. 
			...
			<div class="col-sm-5" style="width:495px; " >
						...
						<div class="row ">
							...
							<div class="videogallery" >
								<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url=video/video_1448740474.mp4" title="Video: Dispositivos Finales"><img src="index_videolb/thumbnails/video_1448740474.png" alt="video_1448740474" /><span></span></a><span class="videolb"><a href="http://videolightbox.com">html video</a> by VideoLightBox.com v3.1</span>
							</div>
												
						    <div class="col-lg-12" style="top:8px; width:528px; left:-15px;" >
								 <div class="panel panel-info" style="text-align: justify; "    >
									<small><b>Descripción del Video:</b> este video ilustra como los mensajes se originan y se reciben en los dispositivos finales.</small> 
								 </div>
  ...
  <ul class="pager" >
    <li class="previous"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo2.3.php"><span aria-hidden="false"><img src="imagenes/left1.png"></span></a></li>
    <li class="next"><a  class="zoom sobre img-circle" onclick="MOTHER1.playclip()" onmouseover="primero.playclip()" href="capitulo2.3.2.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
	<li class="zoom sobre img-circle" onclick="MOTHER2.playclip()" onmouseover="primero.playclip()"><a target="_blank" href="diccionario.pdf"><img src="imagenes/dictionary.png"><span aria-hidden="true"><font color="#000080" > Diccionario</font></span></a></li>
	
	<li class="zoom sobre img-circle" onclick="MOTHER3.playclip()" onmouseover="primero.playclip()"><a target="_blank" href="https://www.dropbox.com/s/98ds8r8zq29rh3z/Cisco_Packet_Tracer_6.1_for_Windows.exe?dl=0"><img src="imagenes/download1.png"><span aria-hidden="true"><font color="#000080" >Simulador</font></span></a></li>
	<li class="zoom sobre img-circle" onclick="MOTHER4.playclip()" onmouseover="primero.playclip()"><a href="principal.php"><img src="imagenes/home.png"><span aria-hidden="true"><font color="#000080" > Inicio</font></span></a></li>
  </ul>
