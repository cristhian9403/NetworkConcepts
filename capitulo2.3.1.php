...
<title>NetworkConcepts</title>
  ...
  <ul class="pager" >
    ...
    <li class="next"><a  class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo2.3.2.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
