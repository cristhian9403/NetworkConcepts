...
<div class="col-lg-3"> 
  ...
  <ul class="pager" >
    <li class="previous" ><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" href="capitulo2.3.2.php" ><span aria-hidden="false"><img src="imagenes/left1.png"></span></a></li>
    <li class="next"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" href="capitulo3.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
