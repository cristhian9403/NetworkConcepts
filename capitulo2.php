...
<body background="imagenes/net.jpg">
  ...
  <ul class="pager" >
    ...
    <li class="next" onclick="MOTHER1.playclip()" onmouseover="primero.playclip()"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo2.1.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
