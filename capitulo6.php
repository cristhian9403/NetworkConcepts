...
<title>NetworkConcepts</title>
  ...
  <ul class="pager" >
    ...
    <li class="next"><a class="zoom sobre img-circle" onclick="MOTHER1.playclip()" onmouseover="primero.playclip()" href="capitulo7.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
