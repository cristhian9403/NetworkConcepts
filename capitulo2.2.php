...
<title>NetworkConcepts</title>
		...
		<div class="row">
                 		<section class="posts col-md-12" STYLE=" top:20px; left:1px;">
                 				<ol class="breadcrumb">
             				       ...
             				       <li class="active"><small>Capitulo 2.2</small></li>	
                 		</section>
             </div>
  ...
  <ul class="pager" >
    <li class="previous"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo2.1.php"><span aria-hidden="false"><img src="imagenes/left1.png"></span></a></li>
    <li class="next"><a  class="zoom sobre img-circle" onclick="MOTHER1.playclip()" onmouseover="primero.playclip()" href="capitulo2.3.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
