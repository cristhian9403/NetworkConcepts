...
<title>NetworkConcepts</title>
						...
						<div id="Layer1" style="width:550px; height:350px; overflow:scroll;">
							...
							<div class="panel-body" style="text-align: justify;" >
							 ...
							 <br>
								...
								elementos en común. El primero de estos elementos es el origen del mensaje o emisor. Los orígenes de los 
								mensajes son las personas o los dispositivos electrónicos que deben enviar un mensaje a otras personas o 
								dispositivos. El segundo elemento de la comunicación es el destino o receptor del mensaje. El destino recibe el 
								mensaje y lo interpreta. Un tercer elemento, llamado canal, está formado por los medios que proporcionan el 
								camino por el que el mensaje viaja desde el origen hasta el destino. 

							<br>
							<br>
								Considere, por ejemplo, que desea comunicar mediante palabras, ilustraciones y sonidos. Cada uno de estos mensajes
								puede enviarse a través de una red de datos o de información convirtiéndolos primero en dígitos binarios o bits. 
								Luego, estos bits se codifican en una señal que se puede transmitir por el medio apropiado. En las redes de 
								computadoras, el medio generalmente es un tipo de cable o una transmisión inalámbrica.
							<br>
							<br>
                                El término red en este curso se referirá a datos o redes de información capaces de transportar gran cantidad de 
								diferentes tipos de comunicaciones, que incluye datos informáticos, voz interactiva, video y productos de 
								entretenimiento.
			...
			<div class="col-sm-5" style="width:495px; " >
						...
						<div class="row ">
							...
							<div class="videogallery" >
								<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url=video/video_1448717647.mp4" title="Video: Elementos de la comunicación"><img src="index_videolb/thumbnails/video_1448717647.png" alt="Video_1448717647" /><span></span></a><span class="videolb"><a href="http://videolightbox.com">html video</a> by VideoLightBox.com v3.1</span>
							</div>
												
						    <div class="col-lg-12" style="top:8px; width:528px; left:-15px;" >
								 <div class="panel panel-info" style="text-align: justify; "    >
									<small><b>Descripción del Video:</b> este video expone los elementos principales para el envío de Información.</small> 
								 </div>
  ...
  <ul class="pager" >
    <li class="previous"><a class="zoom sobre img-circle" onclick="MOTHER.playclip()" onmouseover="primero.playclip()" href="capitulo2.php"><span aria-hidden="false"><img src="imagenes/left1.png"></span></a></li>
    <li class="next"><a class="zoom sobre img-circle" onclick="MOTHER1.playclip()" onmouseover="primero.playclip()" href="capitulo2.2.php"><span aria-hidden="false"><img src="imagenes/right1.png"></span></a></li>
